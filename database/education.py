...
debt = {
    ...
    "description": "What to include: minimum credit card payment, auto, student, or personal loan payments, alimony or child support. Do not include: current rent or monthly utilities, groceries, and other costs of living.",
...
principal = {
    ...
    "description": "This is the home value of a property you are interested in. If you don't have a goal principal, that's okay - we can calculate a potential principal based off your rent",
    "information": "",
...
rent = {
    ...
    "description": "We will use your rent to calculate a principal by using rent as the Monthly Principal amount in the mortgage calculator",
    "information": "",
